# Contributing to Runic Discord Bot

Thank you for considering contributing to the Escalator! Contributions are highly appreciated.
...
```
git clone https://github.com/Pingu-Pox/escalator.git
```
